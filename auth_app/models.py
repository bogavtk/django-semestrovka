...
class UserManager(BaseUserManager):
    ...
    def create_user(self, username, email, user_level, password=None):
        ...
        user = self.model(username=username, user_level=user_level, email=self.normalize_email(email))
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    user_level = models.CharField(max_length=255, default='customer')
